   ...
   return (
    <div className="flex flex-col justify-start items-center">
      <div className="py-2 px-2">
        <img
          className="bg-contain w-[23rem] rounded-md h-[15rem]"
      ...
      <div>
        <h1 className="underline font-bold text-2xl mb-3 text-center">Your photo information</h1>
      </div>
      ...
      <div>
        <ul>
          ...
          <li className="mb-3">
            <span className="font-bold pl-4">Location:</span> 22.3456, 23.423400
          </li>
          <li className="mb-3">
            <span className="font-bold pl-4">Address:</span> 6708 Southwest 78th
            Hollywood,FL
          </li>
        </ul>
      </div>
<div className="flex mt-3 mb-3 justify-center items-center">
    ...
    <div className="flex flex-col justify-center items-center">
     <img className="w-12 h-12 " src="/images/hazard-icon.svg" alt="harzard-image" />
      <p className="text-center w-24">Hazard</p>
      </div>
        
      <div className="flex flex-col justify-center items-center">
        <img className="w-12 h-12" src="/images/road-icon.svg" alt="road-icon"/>
  ...
  <div className="mb-3 xl:w-96">
    <select  defaultValue={selectedCategory} className="form-select appearance-none
      ...
      focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" aria-label="Default select example">
        <option value="0" className="categories flex justify-start" >Categories</option>
  ...
  className="border-2 border-[#C4C4C454] h-[10rem] text-center"></textarea>
